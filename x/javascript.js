...
/**/ document.getElementById("divPago").className = "divsNo"; 
 ...
 document.getElementById("tablaTotal").innerHTML = tablaTotal + '<tr><td> </td> <td></td><td class="preUni"><b>Transporte: </b></td><td class="preTotal"><b>' +totalTransporte+ '</b></td></tr>' + '<tr><td> </td> <td></td><td class="preUni"><b>IVA ('+(IVA*100)+'%): </b></td><td class="preTotal"><b>' +totalIVA+ '</b></td></tr>' + '<tr><td> </td> <td></td><td class="preUni"><b>Total: </b></td><td class="preTotal" id="totalAPagar"><b> $' +totalAPagar+ ' MXN</b></td></tr>';
 } 
...
/**/ document.getElementById("divPago").className = "divsNo"; 
 ...
 var vINE = document.getElementById("ine").value;
 var letras = ['T', 'R', 'W', 'A', 'G', 'M', 'Y', 'F', 'P', 'D', 'X', 'B', 'N',
 'J', 'Z', 'S', 'Q', 'V', 'H', 'L', 'C', 'K', 'E'];
 
 if( !(/^\d{8}[A-Z]$/.test(vINE)) ) {
 todoBien=false;
 document.getElementById("ine").className = "textMal";
 }
 else{
 document.getElementById("ine").className = "textBien";
 }
 
 if(vDNI.charAt(8) != letras[(vINE.substring(0, 8))%23]) {
 todoBien=false;
 document.getElementById("ine").className = "textMal";
 } 
 else{
